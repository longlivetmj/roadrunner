...
@Table(name = "local_invoice_charge_detail_tax")
public class LocalInvoiceChargeDetailTax {
    private Integer localInvoiceChargeDetailTaxSeq;
    ...
    @SequenceGenerator(name = "G1", sequenceName = "local_invoice_charge_detail_tax_seq", allocationSize = 1)
    @Column(name = "local_invoice_charge_detail_tax_seq", unique = true)
    public Integer getLocalInvoiceChargeDetailTaxSeq() {
        return localInvoiceChargeDetailTaxSeq;
    }

    public void setLocalInvoiceChargeDetailTaxSeq(Integer localInvoiceChargeDetailTaxSeq) {
        this.localInvoiceChargeDetailTaxSeq = localInvoiceChargeDetailTaxSeq;
    }

    @Basic
    @Column(name = "local_invoice_charge_detail_seq", insertable = false, updatable = false)
    ...
    public boolean equals(Object o) {
        ...
        LocalInvoiceChargeDetailTax that = (LocalInvoiceChargeDetailTax) o;
        return Objects.equals(localInvoiceChargeDetailTaxSeq, that.localInvoiceChargeDetailTaxSeq) &&
                Objects.equals(localInvoiceChargeDetailSeq, that.localInvoiceChargeDetailSeq) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(localInvoiceChargeDetailTaxSeq, localInvoiceChargeDetailSeq, taxRegistrationSeq, taxTypeSeq, taxPercentage, taxAmount, status);
    }
}
