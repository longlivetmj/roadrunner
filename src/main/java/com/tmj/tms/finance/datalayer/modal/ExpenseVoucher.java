...
public class ExpenseVoucher {
    ...
    private List<ExpenseVoucherChargeDetail> expenseVoucherChargeDetailList;
    private List<ExpenseVoucherExcRateMapping> expenseVoucherExcRateMappings;
    ...
    @SequenceGenerator(name = "G1", sequenceName = "expense_voucher_seq", allocationSize = 1)
    @Column(name = "expense_voucher_seq", unique = true)
    ...
    @Basic
    @Column(name = "expense_voucher_no", nullable = false)
    ...
    @JoinColumn(name = "expense_voucher_seq", nullable = false)
    public List<ExpenseVoucherExcRateMapping> getExpenseVoucherExcRateMappings() {
        return expenseVoucherExcRateMappings;
    }

    public void setExpenseVoucherExcRateMappings(List<ExpenseVoucherExcRateMapping> expenseVoucherExcRateMappings) {
        this.expenseVoucherExcRateMappings = expenseVoucherExcRateMappings;
    }
    ...
    @OneToMany(cascade = {CascadeType.ALL}, fetch = FetchType.LAZY)
    @JoinColumn(name = "expense_voucher_seq", nullable = false)
    public List<ExpenseVoucherChargeDetail> getExpenseVoucherChargeDetailList() {
        return expenseVoucherChargeDetailList;
    }

    public void setExpenseVoucherChargeDetailList(List<ExpenseVoucherChargeDetail> expenseVoucherChargeDetailList) {
        this.expenseVoucherChargeDetailList = expenseVoucherChargeDetailList;
    }
    ...
    public boolean equals(Object o) {
        ...
        ExpenseVoucher that = (ExpenseVoucher) o;
        return Objects.equals(expenseVoucherSeq, that.expenseVoucherSeq) &&
                Objects.equals(expenseVoucherNo, that.expenseVoucherNo) &&
                ...
                Objects.equals(expenseVoucherChargeDetailList, that.expenseVoucherChargeDetailList) &&
                Objects.equals(expenseVoucherExcRateMappings, that.expenseVoucherExcRateMappings);
    }

    @Override
    public int hashCode() {
        return Objects.hash(expenseVoucherSeq, expenseVoucherNo, moduleSeq, exchangeRateSeq, financialChargeSeq, currencySeq, stakeholderSeq, departmentSeq, remark, companyProfileSeq, finalWithoutTaxAmount, finalOtherTaxAmount, finalVatAmount, finalTotalAmount, status, vatOrSVat, expenseVoucherChargeDetailList, expenseVoucherExcRateMappings);
    }
}
