...
@Table(name = "bulk_invoice_charge_detail_tax")
public class BulkInvoiceChargeDetailTax {
    private Integer bulkInvoiceChargeDetailTaxSeq;
    ...
    @SequenceGenerator(name = "G1", sequenceName = "bulk_invoice_charge_detail_tax_seq", allocationSize = 1)
    @Column(name = "bulk_invoice_charge_detail_tax_seq", unique = true)
    public Integer getBulkInvoiceChargeDetailTaxSeq() {
        return bulkInvoiceChargeDetailTaxSeq;
    }

    public void setBulkInvoiceChargeDetailTaxSeq(Integer bulkInvoiceChargeDetailTaxSeq) {
        this.bulkInvoiceChargeDetailTaxSeq = bulkInvoiceChargeDetailTaxSeq;
    }

    @Basic
    @Column(name = "bulk_invoice_charge_detail_seq", insertable = false, updatable = false)
    ...
    public boolean equals(Object o) {
        ...
        BulkInvoiceChargeDetailTax that = (BulkInvoiceChargeDetailTax) o;
        return Objects.equals(bulkInvoiceChargeDetailTaxSeq, that.bulkInvoiceChargeDetailTaxSeq) &&
                Objects.equals(bulkInvoiceChargeDetailSeq, that.bulkInvoiceChargeDetailSeq) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(bulkInvoiceChargeDetailTaxSeq, bulkInvoiceChargeDetailSeq, taxRegistrationSeq, taxTypeSeq, taxPercentage, taxAmount, status);
    }
}
