...
function pageInitializer() {
    ...
    $("html").on("click", function(){
        if(html_click_avail)
            $(".x-navigation-horizontal li,.x-navigation-minimized > span > li, .x-navigation-minimized > li").removeClass('active');
    });
        ...
        stop: function( event, ui ) {
            $(this).resizable({
                ...
                stop: function( event, ui ) {
                    ...
                    $(this).find(".scroll").mCustomScrollbar("up" +
                        "");
    ...
    if($(window).width() > 1024){
        ...
        if($(".page-sidebar").hasClass("scroll")){
            if($("body").hasClass("page-container-boxed")){
                ...
                var doc_height = $(window).height() - 40;
            }
