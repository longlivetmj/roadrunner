var site_settings = '<div class="ts-button" style="padding-top: 5px">'
    + '<span class="fa fa-cogs fa-spin" style="padding-top: 5px"></span>'
    + '</div>'
    + '<div class="ts-body">'
    + '<div class="ts-title">Themes</div>'
    + '<div class="ts-themes">'
    + '<a href="#" data-theme="../../theme/css/theme-default.css"><img src="../../theme/img/themes/default.jpg"/></a>'
    ...
    + '<a href="#" class="active"  data-theme="../../theme/css/theme-white.css"><img src="../../theme/img/themes/light.jpg"/></a>'
...
$(document).ajaxStart(function () {
    $('#loading').show();
    document.getElementById('loadShadowing').style.display = 'block';
}).ajaxStop(function () {
    $('#loading').hide();
    document.getElementById('loadShadowing').style.display = 'none';
});