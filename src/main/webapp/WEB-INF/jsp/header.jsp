...
<ul class="x-navigation x-navigation-horizontal x-navigation-panel">
    ...
    <c:forEach items="${moduleList}" var="module">
        <li class="pull-right">
            <a href="#">
                <span class="xn-text">${module.moduleName}</span>
            </a>
            <c:if test="${fn:length(module.subModuleList) gt 0}">
                <ul class="animated zoomIn">
                    <c:forEach items="${module.subModuleList}" var="subModule">
                        <li onclick="loadLeftNavi('${module.moduleName}/${subModule.subModuleName}')"><a href="#"><span
                                class="fa fa-${subModule.icon}"></span>${subModule.subModuleName}</a></li>
                    </c:forEach>
                </ul>
            </c:if>
        </li>
...
<ul class="breadcrumb">
    <li><a href="#" id="breadcrumbSubModule"></a></li>
    <li class="active" id="breadcrumbDocumentLink"></li>
</ul>
