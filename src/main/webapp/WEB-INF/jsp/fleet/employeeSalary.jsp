...
<script type="text/javascript" src="../../../customjs/fleet/employeeSalary.js"></script>
<div class="page-title">
    <h3><span class="fa fa-money"></span>Salary Management</h3>
</div>
    ...
    <div class="col-md-12">
        <div class="panel panel-default tabs">
            <ul class="nav nav-tabs" role="tablist">
                <li class="active"><a href="#tab-first" role="tab" data-toggle="tab">Salary Management</a></li>
                <li><a href="#tab-second" role="tab" data-toggle="tab">Salary History</a></li>
            </ul>
            <div class="panel-body tab-content">
                    ...
                    <div class="col-md-12">
                        <form class="form-horizontal" method="post" name="searchSalaryForm" id="searchSalaryForm">
                            <div class="form-group removeFromModal">
                                <div class="col-md-7">
                                    <h4 class="subTitle">Payroll & Calculations</h4>
                                </div>
                            </div>
                            <div class="col-md-6">
                ...
                <div class="tab-pane" id="tab-second">
                    <div class="row">
                            ...
                            <form class="form-horizontal" method="post" name="searchForm" id="searchForm">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-9">
                                            <button type="button" class="btn btn-primary pull-right"
                                                    onclick="search_salary_history()">Search
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-group" id="salaryData"></div>
                    </div>
                </div>
                ...
                <div class="modal-body panel" style="font-size: 14px">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <label class="col-md-7 col-xs-12" rv-text="salary.employee.employeeName"></label>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 col-xs-12">Designation</label>
                            <label class="col-md-7 col-xs-12" rv-text="salary.employeeDesignation.designation"></label>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 col-xs-12">Year/Month</label>
                            <label class="col-md-7 col-xs-12" rv-text="salary.yearMonth"></label>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 col-xs-12">Remarks</label>
                            <label class="col-md-7 col-xs-12" rv-text="salary.remarks"></label>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 col-xs-12">Created By</label>
                            <label class="col-md-7 col-xs-12" rv-text="salary.createdBy"></label>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 col-xs-12">Created Date</label>
                            <label class="col-md-7 col-xs-12" rv-text="salary.createdDate"></label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-md-4 col-xs-12">Basic</label>
                            <label class="col-md-7 col-xs-12" rv-text="salary.basicSalary | currency"></label>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 col-xs-12">Allowance</label>
                            <label class="col-md-7 col-xs-12" rv-text="salary.totalAllowance | currency"></label>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 col-xs-12">Commission</label>
                            <label class="col-md-7 col-xs-12" rv-text="salary.totalCommission | currency"></label>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 col-xs-12">Deduction</label>
                            <label class="col-md-7 col-xs-12" rv-text="salary.totalDeduction | currency"></label>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 col-xs-12">Contribution</label>
                            <label class="col-md-7 col-xs-12" rv-text="salary.totalCompanyContribution | currency"></label>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 col-xs-12">Advance</label>
                            <label class="col-md-7 col-xs-12" rv-text="salary.totalSalaryAdvance | currency"></label>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 col-xs-12">Net Pay</label>
                            <label class="col-md-7 col-xs-12" rv-text="salary.netPay | currency" style="font-size: 14px; color: darkred"></label>
                        </div>
                        <input type="hidden" name="salarySeq" id="salarySeq" rv-value="salary.salarySeq">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" value="generateReport"
                            onclick="load_report()">Report
                    </button>
                    <button type="button" class="btn btn-danger"
                            <sec:authorize
                                    access="!hasRole('ROLE_fleet@employeeSalary_DELETE')">
                                disabled="disabled"
                            </sec:authorize>
                            ...
                            data-title="Deleting Salary"
                            data-content="Are you sure you want to Delete this Salary ? "
                            data-id="modal"
                            data-on-confirm="delete_salary">
                        Delete
                    </button>
                </div>
            </form>
            ...
            <form class="form-horizontal" method="post" name="reportModel" id="reportModel">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary pull-right" value="generateReport"
                            onclick="view_salary_report()">Generate
                    </button>
                    <input type="hidden" id="report_salarySeq"/>
                </div>
            </form>
        </div>
    </div>
