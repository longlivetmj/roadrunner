...
<div class="form-group">
                ...
                <table class="table data-table-specific" id="allowanceDetails">
                    ...
                    <c:forEach items="${salary.salaryAllowanceList}" var="salaryAllowance">
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" class="icheckbox" id="salaryAllowanceChargeSeq${allowanceIndex}"
                                       name="salaryAllowanceChargeSeq"
                                       onchange="calculate()" checked
                                       value="${salaryAllowance.chargeSeq}"/>
                            </td>
                        </tr>
                ...
                <table class="table data-table-specific" id="commissionDetails">
                    ...
                    <c:forEach items="${salary.salaryCommissionList}" var="salaryCommission">
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" class="icheckbox" id="salaryCommissionChargeSeq${commissionIndex}"
                                       name="salaryCommissionChargeSeq"
                                       onchange="calculate()" checked
                                       value="${salaryCommission.chargeSeq}"/>
                            </td>
                        </tr>
                ...
                <table class="table data-table-specific" id="deductionDetails">
                    ...
                    <c:forEach items="${salary.salaryDeductionList}" var="salaryDeduction">
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" class="icheckbox" id="salaryDeductionChargeSeq${deductionIndex}"
                                       name="salaryDeductionChargeSeq"
                                       onchange="calculate()" checked
                                       value="${salaryDeduction.chargeSeq}"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" class="icheckbox"
                                       id="salaryCompanyContributionChargeSeq${contributionIndex}"
                                       name="salaryCompanyContributionChargeSeq"
                                       onchange="calculate()" checked
                                       value="${salaryCompanyContribution.chargeSeq}"/>
                            </td>
                        </tr>
    ...
    <div class="panel panel-success">
        <div class="panel-body" style="font-size: 14px">
            <div class="col-md-4">
                <div class="form-group">
                    <label class="col-md-4 col-xs-12">Basic Salary</label>
                    <label class="col-md-7 col-xs-12" id="basicSalary"><fmt:formatNumber type="currency" currencySymbol=" " value="${salary.basicSalary}" /></label>
                </div>
                <div class="form-group">
                    <label class="col-md-4 col-xs-12">Total Advance</label>
                    <label class="col-md-7 col-xs-12" id="salaryAdvance"><fmt:formatNumber type="currency" currencySymbol=" " value="${salary.totalSalaryAdvance}" /></label>
                </div>
                <div class="form-group">
                    <label class="col-md-4 col-xs-12">Net Pay</label>
                    <label class="col-md-7 col-xs-12" id="netPay"><fmt:formatNumber type="currency" currencySymbol=" " value="${salary.netPay}" /></label>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="col-md-4 col-xs-12">Commission</label>
                    <label class="col-md-7 col-xs-12" id="commission"><fmt:formatNumber type="currency" currencySymbol=" " value="${salary.totalCommission}" /></label>
                </div>
                <div class="form-group">
                    <label class="col-md-4 col-xs-12">Allowance</label>
                    <label class="col-md-7 col-xs-12" id="allowance"><fmt:formatNumber type="currency" currencySymbol=" " value="${salary.totalAllowance}" /></label>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="col-md-4 col-xs-12">Deduction</label>
                    <label class="col-md-7 col-xs-12" id="deduction"><fmt:formatNumber type="currency" currencySymbol=" " value="${salary.totalDeduction}" /></label>
                </div>
                <div class="form-group">
                    <label class="col-md-4 col-xs-12">Company Contribution</label>
                    <label class="col-md-7 col-xs-12" id="companyContribution"><fmt:formatNumber type="currency" currencySymbol=" " value="${salary.totalCompanyContribution}" /></label>
                </div>
            </div>
            <div class="panel-heading">
                ...
                <div class="col-md-2">
                    <div class="form-group" style="padding-top: 10px">
                        <button type="button" class="btn btn-primary pull-left" onclick="create_salary()">Submit</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <input type="hidden" name="employeeDesignationSeq" value="${salary.employeeDesignationSeq}"/>
